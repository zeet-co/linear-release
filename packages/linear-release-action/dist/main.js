...
const manifest = [{ "module": "@zeet/linear-release", "exactMatch": "packages/linear-release/src/index.js", "pattern": "packages/linear-release/src/index.ts" }];
...
require("./packages/linear-release-action/src/main.js");
